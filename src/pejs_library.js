...
var pejs_library = new Object();
    pejs_library.co_name = "<module>";
    pejs_library.co_argcount = 0;
    pejs_library.co_nlocals = 0;
    pejs_library.co_varnames = [];
    ...
    pejs_library.co_code =     [ //Instructions
      ...
      [100,12,2,"CONSTANT","<code object str at 0xb7d5ee78, file \"pejs_library.py\", line 4>","LOAD_CONST"],
      [132,15,0,"OTHER","0","MAKE_FUNCTION"],
      [90,18,2,"GLOBAL VARIABLE","str","STORE_NAME"],
      [100,21,3,"CONSTANT","<code object range at 0xb7d6c7b8, file \"pejs_library.py\", line 7>","LOAD_CONST"],
